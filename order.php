...
<section class="p-5 p-md-5 text-sm-start" id="Order">
    <div class="container" style="margin-top: 40px;">
        ...
        <form action="admin/codes.php" method="POST">
            <?php
                $products = getAllActive("product"); // GET ALL ACTIVE PRODUCT
                if(mysqli_num_rows($products) > 0): // CHECK IF THERE ARE PRODUCTS
            ?>
                <div class="row justify-content-center">
                    <?php foreach($products as $product): ?> <!-- LOOP THROUGH ALL PRODUCT -->
                    ...
                    <?php endforeach; ?> <!-- END OF FOR EACH -->
                </div>
            <?php endif; ?>
            <!--------------- CATEGORIES --------------->
                ...
                <div class="addqty">
                    <div class="row align-items-center" >
                        <div class="col-md-10" id="textqty">
                            <h2 style="display: inline; margin-left: -20px; font-weight: bold; font-family: 'Poppins', sans-serif;">Quantity</h2>
                        </div>
            ...
            <!--------------- SUBMIT BUTTON --------------->
            <button type="submit" class="btn btn-md btn-block" name="cartBtn" style="background-color: #AAD7F6; color: #013D67; font-family: 'Poppins', sans-serif; font-size: 24px; font-weight: bold; width: 100%;margin-top: 40px;">Add to Cart</button>
        </form>
    </div>
</section>
